...
<html>
  ...
  <body>
    ...
    $conexion=conectarBD();
    $query ="SELECT *from comentario where num_proyecto=$n_proyecto;";
    ...
    ?>
    <img class="nuevo_comentario_img" src='../../css/img/hacer_comentario.png' >
    <p><a class="nuevo_comentario" href="#popup">Redactar</a></p>
